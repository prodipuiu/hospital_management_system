...
<?php
		...
		<div class="ui container">
				...
				<div  style="width: 10%">
					<a href="ad7.php"><button class="ui fluid button" style="background-color:#4ef18f">Add Contact</button></a></div>
					<div  style="width: 10%">
						<a href="n_pp.php"><button class="ui fluid button" style="background-color: red ">Paitient Report</button></a></div>
					...
					<form class="ui center aligned basic segment" method="post" action="sch7.php">
